  ...
  <div>
    ...
    <div>
      <el-form :model="khfp" :rules="rules" ref="khfp" :inline="true" style="margin-left: 50px; margin-top: 50px;">
        ...
        <el-form-item label="分配编号"  label-width="100px" prop="khfp_bh">
          <el-input v-model="khfp.khfp_bh" disabled style="width: 300px;" placeholder="系统自动生成" ></el-input>
        </el-form-item>
        <el-form-item label="客户姓名" label-width="100px" prop="khxx_xm">
          <!-- <el-input v-model="khfp.khxx_xm" style="width: 300px;"></el-input> -->
          <el-select v-model="khfp.khxx_xm" placeholder="请选择客户" style="width: 300px;">
        ...
        <el-form-item label="客户类型" label-width="100px" prop="khxx_khlx">
          <!-- <el-input v-model="khfp.khxx_khlx" style="width: 300px;"></el-input> -->
          <el-input v-model="khfp.khxx_khlx"  style="width: 300px;"></el-input>
        </el-form-item>
        <el-form-item label="客户行业" label-width="100px" prop="khxx_khhy">
          <el-input v-model="khfp.khxx_khhy" style="width: 300px;"></el-input>
        </el-form-item><br />
        <el-form-item label="业务员编号" label-width="100px" prop="user_number">
          ...
          <el-input v-model="khfp.user_number" style="width: 300px;"></el-input>
        ...
        <el-form-item label="业务员名称" label-width="100px" prop="user_mc">
          <!-- <el-input v-model="khfp.user_mc" style="width: 300px;"></el-input> -->
          <el-select v-model="khfp.user_mc" placeholder="请选择业务员" style="width: 300px;">
            <el-option label="民营企业" value="民营企业"></el-option>
            <el-option label="外资企业" value="外资企业"></el-option>
            <el-option label="事业单位" value="事业单位"></el-option>
            <el-option label="政府单位" value="政府单位"></el-option>
