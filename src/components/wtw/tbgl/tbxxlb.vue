    ...
    <div>
      <template>
        <el-table :data="ruleForm" border style="width: 100%" >
         <el-table-column prop="tbxxName" label="项目名称" width="350"></el-table-column>
         <el-table-column prop="tbxxLx" label="项目类型" width="220"></el-table-column>
         <el-table-column prop="tbxxDz" label="项目地址"width="320"></el-table-column>
         <el-table-column prop="tbxxLrr" label="录入人" width="120"></el-table-column>
         <el-table-column prop="tbxxTbrq" label="日期" width="320"></el-table-column>
         <el-table-column prop="tbxxFzr" label="投标负责人" width="120"></el-table-column>
         <el-table-column prop="tbxxJsdw" label="建设单位" width="320"></el-table-column>
         ...
         <el-table-column prop="tbxxSpjg" label="流程状态" width="120">
          ...
          <el-table-column fixed="right" label="操作" width="150">
            <template slot-scope="scope" >
              <el-button v-if="scope.row.tbxxSpjg==0" type="text" @click="tbxxUpdate(scope.row.tbxxBh)" size="small">提交审批</el-button>
              <!-- <el-button type="text" size="small">编辑</el-button> -->
              <el-button type="text" v-if="scope.row.tbxxSpjg==0" @click="tbxxDelete(scope.row.tbxxBh)" size="small">删除</el-button>
              <el-button  v-if="scope.row.tbxxSpjg==1" type="text" size="small" @click="tbxxUpdate1(scope.row.tbxxBh)" >通过</el-button>
              <el-button type="text" v-if="scope.row.tbxxSpjg==1" size="small" @click="tbxxUpdate2(scope.row.tbxxBh)" >不通过</el-button>
            </template>
          </el-table-column>
        </el-table>
      </template>
