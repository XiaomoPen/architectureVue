...
<template>
  <div>
    <el-form :inline="true" :rules="rules" :model="ruleForm" ref="ruleForm" label-width="120px"
      ...
      <h2 style="text-align: center;">项目业务费申请</h2>
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="业务费编号:" prop="zgzsZsbh">
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="项目类型:" prop="zgzsJsdw">
            <el-input v-model="ruleForm.zgzsJsdw">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="银行账户:" prop="zgzsSqr" clearable>
            <el-input v-model="ruleForm.zgzsSqr">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="开户人:" prop="zgzsJsdw">
        ...
        <el-col :span="8">
          <el-form-item label="申请人:" prop="zgzsXmlx">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="申请事由:" prop="zgzsBz">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="备注:" prop="zgzsBz">
            <el-input type="textarea" placeholder="备注" v-model="ruleForm.zgzsBz" rows="5" maxlength="500"
              style="width: 1200px;" show-word-limit>
            </el-input>
          </el-form-item>
        </el-col>
