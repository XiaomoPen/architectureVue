    ...
    <div>
      ...
      <template>
        <el-table :data="tableData" border style="width: 100%" >
          <el-table-column prop="user.userName" label="员工" width="90px"></el-table-column>
          <el-table-column prop="contractLeix" label="合同类型" ></el-table-column>
          <el-table-column prop="contractSigning" label="签约时间" width="220px"></el-table-column>
            <el-table-column prop="contactJieshu" label="试用结束时间" ></el-table-column>
          <el-table-column prop="contractState" label="合同状态" width="120px"></el-table-column>
          <el-table-column prop="contractFailure" label="失效时间" ></el-table-column>
...
name: "contract",
  ...
  methods: {
    ...
    initData(page, size) {//当前页，页大小
      this.$axios.get("http://localhost:7777/tpm/find-Contract", {params: {pageNum: page, size: size}})
        .then((v) => {
    ...
    likeMgr(page, size, search) {//当前页，页大小
      this.$axios.get("http://localhost:7777/find-Contract2", {
        params: {
          pageNum: page,
          size: size,
