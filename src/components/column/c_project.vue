        ...
        <el-menu class="el-menu-vertical-demo" background-color="#4791eb" text-color="#fff"
          ...
          <el-submenu index="1">
            ...
            <el-submenu index="1-1">
              ...
              <el-menu-item index="1-1-1">投标项目信息登记</el-menu-item>
              <el-menu-item index="1-1-2">项目信息列表</el-menu-item>
            </el-submenu>
            <el-submenu index="1-2">
              <template slot="title">招标文件购买</template>
              <el-menu-item index="1-2-1">招标文件购买申请</el-menu-item>
              <el-menu-item index="1-2-2">招标文件购买列表</el-menu-item>
            </el-submenu>
            <el-submenu index="1-3">
              <template slot="title">资格自审</template>
              <el-menu-item index="1-3-1">资格自审</el-menu-item>
              <el-menu-item index="1-3-2">资格自审列表</el-menu-item>
              <el-menu-item index="1-3-3">投标文件审查</el-menu-item>
              <el-menu-item index="1-3-4">投标文件审查列表</el-menu-item>
            </el-submenu>
            <el-submenu index="1-4">
              <template slot="title">项目勘察</template>
              <el-menu-item index="1-4-1">项目勘察</el-menu-item>
              <el-menu-item index="1-4-2">项目勘察列表</el-menu-item>
            </el-submenu>
            <el-submenu index="1-5">
              <template slot="title">投标保证金申请</template>
              <el-menu-item index="1-5-1">投标保证金申请</el-menu-item>
              <el-menu-item index="1-5-2">投标保证金申请列表</el-menu-item>
            </el-submenu>
            <el-submenu index="1-6">
              <template slot="title">开标记录</template>
              <el-menu-item index="1-6-1">开标登记</el-menu-item>
              <el-menu-item index="1-6-2">竞争对手情况列表</el-menu-item>
              <el-menu-item index="1-6-3">中标结果登记</el-menu-item>
              <el-menu-item index="1-6-4">中标结果登记列表</el-menu-item>
            </el-submenu>
            <el-submenu index="1-7">
              <template slot="title">项目业务费申请</template>
              <el-menu-item index="1-7-1">项目业务费申请</el-menu-item>
              <el-menu-item index="1-7-2">项目业务费申请列表</el-menu-item>
            </el-submenu>
          </el-submenu>
          <el-submenu index="2">
            <template slot="title">
